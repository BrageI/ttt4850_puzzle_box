...
int main() {
    ...
    std::vector<Book> books{
        ...
        {0, 5.0f, PIN_ULTRASONIC0_TRIG, PIN_ULTRASONIC0_ECHO, 20.f, 12.f},
        {1, 7.0f, PIN_ULTRASONIC1_TRIG, PIN_ULTRASONIC1_ECHO, 20.f, 12.f},
        {2, 2.0f, PIN_ULTRASONIC2_TRIG, PIN_ULTRASONIC2_ECHO, 20.f, 12.f},
        {3, 4.0f, PIN_ULTRASONIC3_TRIG, PIN_ULTRASONIC3_ECHO, 20.f, 12.f},
        {4, 3.0f, PIN_ULTRASONIC4_TRIG, PIN_ULTRASONIC4_ECHO, 20.f, 12.f},
    };
